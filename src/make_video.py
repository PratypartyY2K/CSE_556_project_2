...
def create_video_from_frames(image_folder, output_video_path, fps=10):
    ...
    # Critical: Sort alphabetically to ensure chronological sequence
...
def main():
    ...
    # Create the assets folder if it somehow doesn't exist
    os.makedirs("assets", exist_ok=True)

    # You can adjust the FPS (Frames Per Second)
    # Try 10 for a standard look or 24 for a cinematic feel
